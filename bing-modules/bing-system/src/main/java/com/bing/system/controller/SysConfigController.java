...
public class SysConfigController extends BaseController
{
    ...
    /**
     * 该接口用于避免AAD登录成功后页面出现"登录状态已过期，您可以继续留在该页面，或者重新登录"，/security-banners加入gateway白名单
     * @return
     */
    @PostMapping(value = "/security-banners")
    public AjaxResult getSecurityBannerValue() {
        // 6为SecurityBanner主键
        return success(configService.selectConfigById(6L));
    }
